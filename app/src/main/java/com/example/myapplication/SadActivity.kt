...
import com.example.myapplication.databinding.ActivitySadBinding
...
class SadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivitySadBinding.inflate(layoutInflater)
    ...
    private fun doBackgroundWork(): String {
        ...
        return crawlYoutubeVideoTitle() //title
    }

    private fun crawlYoutubeVideoTitle(): String {
